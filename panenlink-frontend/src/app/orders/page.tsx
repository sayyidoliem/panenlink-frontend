...
export default function Page() {
  ...
  // Driver phone numbers would come from the backend in production.
  // Using a placeholder here — replace with real number from your driver DB.
  const activeShipment = {
    ...
    destination: "Jakarta",
    driverName: "Pak Agus",
    driverPhone: "6281234567890", // format: 62XXXXXXXXXXX (no +, no spaces)
    vehiclePlate: "B 9284 FCO",
    vehicleType: "CDD Box",
    status:
      step >= 3
  ...
  // WhatsApp deep-link → opens chat with driver, pre-filled message
  const waDriver = `https://wa.me/${activeShipment.driverPhone}?text=${encodeURIComponent(
    `Halo Pak Agus, saya menghubungi terkait muatan #${activeShipment.loadId} (${activeShipment.commodity} ${activeShipment.weight}). Bisa konfirmasi posisi sekarang?`,
  )}`;
          ...
          <section className="card tracking">
            <div>
              ...
              <footer>
                ...
                <a href={waDriver} target="_blank" rel="noreferrer" className="button primary">
                  <Phone />
                  Chat Driver WA
                </a>
